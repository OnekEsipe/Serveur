...
public class EventAccueilBean implements Serializable {
	 ...
	 * @return signingNeeded Lien avec la checkbox signature
	 */
	...
	/**
	 * Setter de la variable signingNeeded
	 * @param signingNeeded Lien avec la checkbox signature
	 */
	 ...
	 * @return isOpened Lien avec la checkbox ouvert à l'inscription
	 */
	 ...
	 * @param isOpened Lien avec la checkbox ouvert à l'inscription
	 */
